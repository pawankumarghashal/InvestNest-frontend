    ...
    <div className="container text-color">
      <div className="row mt-5">
        <div className="mt-5 mb-5 ">
          <h1 className="fs-2  " style={{textAlign:"center"}}>
            We pioneered the discount broking model in India.</h1>
            <h1 className="fs-2  " style={{textAlign:"center"}}>Now, we are
            breaking ground with our technolog.
          </h1>
        </div>
      </div>
      <div className="row mt-5 border-top big-text text-color">

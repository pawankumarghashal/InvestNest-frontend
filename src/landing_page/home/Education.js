...
function Education() {
    return ( 
         <div className='container mt-5 '>
            <div className='row'>
                <div className='col-6 '>
                    <img src='Media\image\education.svg' alt='eductaion img' style={{width:"70%"}}/>
                ...
                <div className='col-6 mt-5 '>
                    ...
                    <a href='' style={{textDecoration:"none"}}>TradingQ&A<i class="fa fa-long-arrow-right ms-1" aria-hidden="true"></i></a>
                </div>
            </div>
         </div>
     );

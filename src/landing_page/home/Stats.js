...
function Stats() {
  ...
  <h2 className='fs-4'>The InvestNest universe</h2>
  ...
  <h2 className='fs-4'>Do better with money</h2>
      <p className='text-muted'>With initiatives like Nudge and Kill Switch, we don't just facilitate transactions, but actively help you do better with your money.
        ...
        <div className='col-6 mt-5 p-3'>
            <img style={{width:"90%"}} src='Media\image\ecosystem.png' alt='ecosystem' />
          
            <div  className=''    style={{textAlign:"center"}}>
                <a  className='mx-4'  style={{textDecoration:"none"}} href=''>Explore our products <i class="fa fa-long-arrow-right" aria-hidden="true"></i></a> 
